      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="manage_recipe_list.php" style="font-weight: bold;">레시피목록</a>
          </li>
...
<div>
    ...
    $query = "select recipe_id, member_id, recipe_title, recipe_category, click_count from recipe_write order by recipe_date desc";
    ...
    <table align=center>
        <thead align="center">
            <tr style="font-weight: bold;">
                ...
                <td width="300" align="center">레시피명</td>
        ...
        <tbody>
            ...
            ?>
                    ...
                    <td width="300" align="center"><?php echo $rows['recipe_title'] ?></td>
                    <td width="120" align="center"><?php echo $rows['recipe_category'] ?></td>
                    <td width="120" align="center"><?php echo $rows['click_count'] ?></td>
                    <td width="100" align="center"><a href="delete_manage_recipe.php?recipe_id=<?php echo $rows['recipe_id']; ?> " class="btn btn-danger" onclick="return confirm('삭제하시겠습니까?')">delete</a></td>
                    </tr>
                <?php
                $total--;
            }
...
<div style="margin-left: 10px;">
    <a href="initialize_view_count.php" class="btn btn-danger" onclick="return confirm('조회수를 초기화 하시겠습니까?')">조회수 초기화</a>
</div>
