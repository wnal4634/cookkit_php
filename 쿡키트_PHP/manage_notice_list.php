    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item" href="manage_notice_list.php" style="font-weight: bold;">공지사항 목록</a>
...
<?php
    ...
    $query = "select notice_id, notice_title, notice_content, notice_date from notice_info order by notice_date desc";
    ...
    <table align=center>
        <thead align="center">
            <tr style="font-weight: bold;">
                ...
                <td width="120" align="center">공지아이디</td>
        ...
        <tbody>
            ...
            ?>
                    ...
                    <td width="120" align="center"><?php echo $rows['notice_id'] ?></td>
                    <td width="120" align="center"><?php echo $rows['notice_title'] ?></td>
                    <td width="500" align="center"><?php echo $rows['notice_content'] ?></td>
                    <td width="200" align="center"><?php echo $rows['notice_date'] ?></td>
                    <td width="100" align="center"><a href="delete_notice.php?notice_id=<?php echo $rows['notice_id']; ?> " class="btn btn-danger" onclick="return confirm('삭제하시겠습니까?')">delete</a></td>
                    </tr>
                <?php
                $total--;
            }
